    ...
    generateRecommendations(stats, alerts) {
        ...
        if (parseInt(stats.active_insurances) === 0) {
            recommendations.push({
                ...
                description: 'Vous devez souscrire une assurance décennale pour exercer légalement dans le BTP',
        ...
        if (parseInt(stats.active_certifications) === 0) {
            recommendations.push({
                ...
                description: 'Obtenez des certifications (RGE, Qualibat) pour améliorer votre crédibilité',
        ...
        try {
            ...
            return {
                ...
                summary: {
                    ...
                    resolvedAlerts: historyResult.rows.filter(a => a.is_resolved).length,
                    criticalAlerts: historyResult.rows.filter(a => a.severity === 'critical').length,
