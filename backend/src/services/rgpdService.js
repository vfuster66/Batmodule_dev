  ...
  async deleteUserData(userId, keepAccountingData = true) {
    try {
      return await transaction(async (client) => {
        ...
        // 3. Supprimer les données de contact (seulement si pas de conservation comptable)
        if (!keepAccountingData) {
        ...
        // 4. Supprimer les paramètres entreprise (seulement si pas de conservation comptable)
        if (!keepAccountingData) {
