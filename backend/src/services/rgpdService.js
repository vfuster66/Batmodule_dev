...
class RGPDService {
    ...
    async purgeDataByRetentionPolicy(retentionPolicy = {}) {
        try {
            ...
            prospectionCutoff.setFullYear(prospectionCutoff.getFullYear() - prospectionYears);
            ...
            const archivePurgeResult = await archivingService.purgeArchives(accountingYears);
