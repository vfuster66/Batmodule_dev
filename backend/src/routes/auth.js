...
router.post('/register', authLimiter, async (req, res, next) => {
    try {
        ...
        const { email, password, firstName, lastName, companyName, phone, address } = value;
        ...
        try {
            const { createDefaultSettings } = require('../services/companySettingsService')
        ...
        } catch (_) { /* ne bloque pas l'inscription */ }
