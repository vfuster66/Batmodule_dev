...
async function ensureSchema() {
    ...
    await query("ALTER TABLE company_settings ADD COLUMN IF NOT EXISTS credit_prefix VARCHAR(10) DEFAULT 'AVO'");
    await query('ALTER TABLE company_settings ADD COLUMN IF NOT EXISTS credit_counter INTEGER DEFAULT 0');
