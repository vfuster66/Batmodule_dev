  ...
  actions: {
    ...
    async getClient(id) {
      ...
      try {
        ...
        this.error = error
        useToast().error('Erreur lors du chargement du client.')
        throw error
      } finally {
        this.loading = false
      }
    ...
    async createClient(clientData) {
      ...
      try {
        ...
        // Debug payload shape (sans données personnelles)
        console.debug('POST /clients payload received')
    ...
    async updateClient(id, clientData) {
      ...
      try {
        const payload = mapClientPayload(clientData)
        console.debug('PUT /clients payload received')
